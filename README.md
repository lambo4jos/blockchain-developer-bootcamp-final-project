...
5. Make sure the port number is 8545
...
7. Navigate into the project root directory
...
10. Now that the smart contracts have been deployed onto the Ganache GUI blockchain, run the react app by typing  "npm start" to launch the react client in a browser that you have already installed Metamask
...
14. Once connected, data will populate the screen with 5 farming rates which list their cost in ether, and the requirements for how long they take to farm, along with the reward paid once farming is complete
...
Please see the tests inside /test/GameFarm.test.js
